...
PUBLIC void welcome()
{
	...
	printf("              ******************************************************\n");
	printf("              *                                                    *\n");
	printf("              *         Welcome to nOSad! Operating System         *\n");
	printf("              *                                                    *\n");
	printf("              ******************************************************\n");
	printf("              *                                                    *\n");
	printf("              *                                                    *\n");
	printf("              *                1952040  Jia Jingwei                *\n");
	printf("              *                2054321  Chen Liangqi               *\n");
	printf("              *                1952774  He Changyong               *\n");
        printf("              *                1951606  Lin Haochuan               *\n");
	printf("              *                                                    *\n");
	printf("              *                                                    *\n");
	printf("              ******************************************************\n\n");
}
...
void help()
{
	...
	printf("        hanoi              |           Start game hanoi\n");
	printf("        mergeten           |           Start game mergeten\n");
...
void login(char * username, char * password)
{
	...
	for (i = 0; i < usercount; i++)
	{
		...
		else if(strcmp(username, users[i]) == 0)
		{
